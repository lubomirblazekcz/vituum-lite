...
const plugin = (pluginUserConfig) => ({
    ...
    configureServer (viteDevServer) {
        const viewsPath = relative(viteDevServer.config.root, resolve(viteDevServer.config.root, pluginUserConfig.pages.dir))
        const viewsIgnoredPaths = pluginUserConfig.pages.ignoredPaths
        const formats = pluginUserConfig.pages.formats
